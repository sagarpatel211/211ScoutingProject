...
#---------- TEAMS -------------#
team211Z = Team ("211Z",[],[],[],[],[],[],[],[],[],[],[],None,None,None)
team211S = Team ("211S",[],[],[],[],[],[],[],[],[],[],[],None,None,None)
...
#1 - 211Z
#team211Z.display()
#team211Z.submitscoutinginfo()
#window.mainloop()
display(team211Z)
# Once you submit, CLOSE THE WINDOW (potentially twice) UNTIL the next one opens
